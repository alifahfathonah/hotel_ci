    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <!-- <li><a href="<?php echo base_url(); ?>fasilitas"><i class="fa fa-list"></i><span>Fasilitas</span></a></li> -->
          <!-- <li><a href="<?php echo base_url(); ?>lantai_kamar"><i class="fa fa-building"></i><span>Lantai Kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>tipe_kamar"><i class="fa fa-tv"></i><span>Tipe Kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>kelas_kamar"><i class="fa fa-star-o"></i><span>Kelas Kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>kamar"><i class="fa fa-bookmark-o"></i><span>Kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>jenis_ruangan"><i class="fa fa-list"></i><span>Jenis Ruangan</span></a></li>
          <li><a href="<?php echo base_url(); ?>ruangan"><i class="fa fa-bookmark-o"></i><span>Ruangan</span></a></li>
          <li><a href="<?php echo base_url(); ?>user"><i class="fa fa-users"></i><span>User</span></a></li>
          <li><a href="<?php echo base_url(); ?>transaksi"><i class="fa fa-exchange"></i><span>Transaksi kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>transaksi_ruangan"><i class="fa fa-exchange"></i><span>Transaksi Ruangan</span></a></li>

          <li><a href="<?php echo base_url(); ?>transaksi/laporan_kamar"><i class="fa fa-print"></i><span>Laporan kamar</span></a></li>
          <li><a href="<?php echo base_url(); ?>transaksi_ruangan/laporan_ruangan"><i class="fa fa-print"></i><span>Laporan ruangan</span></a></li>

          <li><a href="<?php echo base_url(); ?>manajemen_menu"><i class="fa fa-gear"></i><span>Manajemen menu</span></a></li> -->
